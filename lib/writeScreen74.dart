...
class WriteScreen74 extends StatefulWidget {
  @override
...
class _WriteScreen11State extends State<WriteScreen74> {
...
//                ),
                    ...
                    child: FlareActor("assets/क्ष.flr",
...
//                  _points.clear();
                          Navigator.push(
                            context,
                            CustomRoute(builder: (context) => videoScreen75()),
                          );
