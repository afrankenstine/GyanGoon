...
class WriteScreen64 extends StatefulWidget {
  @override
...
class _WriteScreen11State extends State<WriteScreen64> {
...
//                  _points.clear();
                          Navigator.push(
                            context,
                            CustomRoute(builder: (context) => videoScreen65()),
                          );
