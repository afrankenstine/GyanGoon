...
class WriteScreen23 extends StatefulWidget {
  @override
...
class _WriteScreenState extends State<WriteScreen23> {
...
//                  _points.clear();
                          Navigator.push(
                            context,
                            CustomRoute(builder: (context) => videoScreen24()),
                          );
//                    _points.clear();
                          // Here you can write your code for open new view
                        });
